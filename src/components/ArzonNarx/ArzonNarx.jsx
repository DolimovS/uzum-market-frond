...
import { ArzonNarxlar } from '../../DataUzum/DataUzum'
import "../Elektronika/Elektronika.css"

const ArzonNarx = () => {
  return (
    <div>
       <h1 className="product_catogoriya" style={{ textAlign: "left" }}>ArzonNarxlar</h1>
            <div className="product_cards uzum_cards">
                {ArzonNarxlar.map((item) =>
                    <div
